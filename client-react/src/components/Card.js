            ...
            <div className= "container-fluid1 d-flex justify-content-center">
                <div className="row">
                    <div className="col-lx">
                        ...
                        <a  className="links" href="https://www.linkedin.com/in/briandlewis0612/"><i class="fab fa-linkedin"></i></a>
                        
                    </div>
                    <div className="col-lx">
                        <Card imgsrc= {Gio_Nava} title= "Giovanni Nava" text="Junior Developer"  />
                        <a  className="links" href="https://www.linkedin.com/in/giovannie-nava"><i class="fab fa-linkedin"></i></a>
                    </div>
                    <div className="col-lx">
                        <Card imgsrc={Chris_Whiting} title= "Chris Whiting" text="Junior Developer"/>
                        <a  className="links" href="https://www.linkedin.com/in/chris-whiting-4b817a120/"><i class="fab fa-linkedin"></i></a>
                    </div>
                    <div className="col-lx">
                        <Card imgsrc={Beckie_Rich} title= "Beckie Rich" text="Junior Developer"/>
                        <a  className="links" href="https://www.linkedin.com/in/beckie-rich-22164254/"><i class="fab fa-linkedin"></i></a>
                    </div>
                    <div className="col-lx">
                        <Card imgsrc={Scott_Thompson} title= "Scott Thompson" text="Junior Developer"/>
                        <a  className="links" href="https://www.linkedin.com/in/scott-thompson-7ba618199/"><i class="fab fa-linkedin"></i></a>
                    </div>
                </div>
            </div>
        );
